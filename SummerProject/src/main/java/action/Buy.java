...
public class Buy extends BaseAction{
	...
	public String execute(){
		...
		case 5:
			item_coin = appService.getItemById(5).getCoin();
			if (gamedata.getCoin()<=item_coin){
				addFieldError("shopresult","购买失败，金币不足");
				return ERROR;
			}
				...
				gamedata.setCoin(gamedata.getCoin()-item_coin);
				gamedata.setItem5(gamedata.getItem5()+1);
				addFieldError("shopresult","购买成功");
				appService.updateGamedata(gamedata);
				return SUCCESS;
			}
		...
		case 6:
			item_coin = appService.getItemById(6).getCoin();
			if (gamedata.getCoin()<=item_coin){
				addFieldError("shopresult","购买失败，金币不足");
				return ERROR;
			}
				...
				gamedata.setCoin(gamedata.getCoin()-item_coin);
				gamedata.setItem6(gamedata.getItem6()+1);
				addFieldError("shopresult","购买成功");
				appService.updateGamedata(gamedata);
				return SUCCESS;
			}
		case 7:
			item_coin = appService.getItemById(7).getCoin();
			if (gamedata.getCoin()<=item_coin){
				addFieldError("shopresult","购买失败，金币不足");
				return ERROR;
			}
				...
				gamedata.setCoin(gamedata.getCoin()-item_coin);
				gamedata.setItem7(gamedata.getItem7()+1);
				addFieldError("shopresult","购买成功");
				appService.updateGamedata(gamedata);
				return SUCCESS;
			}
