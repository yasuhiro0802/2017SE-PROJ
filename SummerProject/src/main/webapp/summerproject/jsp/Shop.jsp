...
<%
	...
	Integer had_item1 = (Integer)gamedata.getItem1();
    ...
    <div class="row">
      ...
      <div class="span3">
        <div class="photographer">
          ...
          <h3>道具1</h3>
          <p>在单人模式中，你能够使用道具1与电脑pk。</p>
          <p>适用于单人模式</p>
          <p>所需金币：100</p>
          <h4><a href="buy?item=4" >点击购买</a></h4>
        </div>
      </div>
      ...
      <div class="span3">
        <div class="photographer">
           <div class="photo-frame-1"><img src="<%=path%>/summerproject/images/character/1.png" alt="One" /></div>
          <h3>道具2</h3>
          <p>在单人模式中，你能够使用道具2与电脑pk。</p>
          <p>适用于单人模式</p>
          <p>所需金币：200</p>
          <h4><a href="buy?item=5" >点击购买</a></h4>
        </div>
      </div>
      ...
      <div class="span3">
        <div class="photographer">
           <div class="photo-frame-1"><img src="<%=path%>/summerproject/images/character/1.png" alt="One" /></div>
          <h3>道具3</h3>
          <p>在单人模式中，你能够使用道具3与电脑pk。</p>
          <p>适用于单人模式</p>
          <p>所需金币：300</p>
          <h4><a href="buy?item=6" >点击购买</a></h4>
        </div>
       </div>
    </div>
  </div>
...
<!--Start slide3-->
<div class="scroll-slide" id="slide1" data-move="3" data-stellar-background-ratio="0.5">
  <div class="slide4-separator"></div>
  <div class="container">
    <div class="row">
      <div class="slidename">其他</div>
      
      <div class="span3">
        <div class="photographer">
           <div class="photo-frame-1"><img src="<%=path%>/summerproject/images/character/1.png" alt="One" /></div>
          <h3>其他1</h3>
          <p>在单人模式中，你能够使用其他1与电脑pk。</p>
          <p>适用于单人模式</p>
          <p>所需金币：400</p>
          <h4><a href="buy?item=7" >点击购买</a></h4>
        </div>
      </div>
