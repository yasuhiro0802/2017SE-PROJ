  ...
  <div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
      ...
      <div class="item item2">
        <div class="carousel-caption">
          <a href="rank_player" ><h4>排位模式</h4></a>
        </div>
      </div>
      <div class="item item3">
        <div class="carousel-caption">
          <a href="team_player" ><h4>组队模式</h4></a>
        </div>
      </div>
    </div>
      ...
      <div class="span12">
        <div id="filtering">
          <ul>
            ...
            <li><a href="rank_player" >排位模式</a></li>
            <li><a href="team_player" >组队模式</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<div class="scroll-slide" id="slide5" data-move="4" data-stellar-background-ratio="0">
  ...
  <div class="container">
    <div class="row">
	<div class="slidename" data-stellar-background-ratio="0.6"><a>游戏介绍</a></div>
	<div class="span12">
       <div class="fancy-heading-big">
          <h5><a href="detail" >游戏详细介绍</a></h5>
       </div>
      </div>  
      <div class="span3">
      ...
      <div class="span3">
        <div class="photographer">
          ...
          <h3>组队模式</h3>
          <p>在组队模式中，玩家可以创建或加入房间，选择对手玩家进行对战。</p>
          <div class="skill">难度</div>
          <div class="progress progress-danger progress-striped active">
