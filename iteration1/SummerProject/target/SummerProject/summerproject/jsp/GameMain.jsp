...
<%
	...
	Integer singlegame = (Integer)session.getAttribute("singlegame");
	Integer singlewin = (Integer)session.getAttribute("singlewin");
	Integer rankgame = (Integer)session.getAttribute("rankgame");
	Integer rankwin = (Integer)session.getAttribute("rankwin");
	Integer teamgame = (Integer)session.getAttribute("teamgame");
	Integer teamwin = (Integer)session.getAttribute("teamwin");	*/
...
<div class="scroll-slide" id="slide4" data-move="5" data-stellar-background-ratio="0.5">
  <div class="slide4-separator"></div>
  <div class="container">
    <div class="slidename"><a href="logout" >退出登录</a></div>
   </div>
   </div>
